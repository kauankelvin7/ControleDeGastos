...
// Inner form — sem useSearchParams para simplificar
function NovoDividendoForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(`Erro ao salvar dividendo: ${err?.message || "Tente novamente"}`);
      setLoading(false);
    }
  };
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="md:col-span-2">
            <label className="text-xs font-display font-bold text-text-secondary uppercase tracking-wider px-1 mb-2 block">
              Ticker do Ativo
            </label>
            <input
              type="text"
